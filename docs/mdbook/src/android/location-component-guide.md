...
```kotlin
{{#include ../../../../platform/android/TrackAsiaGLAndroidSDKTestApp/src/main/java/org/track-asia/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:top}}
```
...
```kotlin
{{#include ../../../../platform/android/TrackAsiaGLAndroidSDKTestApp/src/main/java/org/track-asia/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:permission}}
```
...
```kotlin
{{#include ../../../../platform/android/TrackAsiaGLAndroidSDKTestApp/src/main/java/org/track-asia/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:onMapReady}}
```
...
```kotlin
{{#include ../../../../platform/android/TrackAsiaGLAndroidSDKTestApp/src/main/java/org/track-asia/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:LocationComponentActivationOptions}}
```
...
[Test APP]: https://github.com/track-asia/trackasia-native/tree/main/platform/android/TrackAsiaGLAndroidSDKTestApp/src/main/java/org/track-asia/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt
