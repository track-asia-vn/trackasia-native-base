...
public class LocationComponentOptions implements Parcelable {
  ...
  public static LocationComponentOptions createFromAttributes(@NonNull Context context,
    ...
    TypedArray typedArray = context.obtainStyledAttributes(
      styleRes, R.styleable.trackasia_LocationComponent);
    ...
    builder.foregroundDrawable(typedArray.getResourceId(
      R.styleable.trackasia_LocationComponent_trackasia_foregroundDrawable, -1));
    if (typedArray.hasValue(R.styleable.trackasia_LocationComponent_trackasia_foregroundTintColor)) {
      builder.foregroundTintColor(typedArray.getColor(
        R.styleable.trackasia_LocationComponent_trackasia_foregroundTintColor, -1));
    }
    builder.backgroundDrawable(typedArray.getResourceId(
      R.styleable.trackasia_LocationComponent_trackasia_backgroundDrawable, -1));
    if (typedArray.hasValue(R.styleable.trackasia_LocationComponent_trackasia_backgroundTintColor)) {
      builder.backgroundTintColor(typedArray.getColor(
        R.styleable.trackasia_LocationComponent_trackasia_backgroundTintColor, -1));
    }
    builder.foregroundDrawableStale(typedArray.getResourceId(
      R.styleable.trackasia_LocationComponent_trackasia_foregroundDrawableStale, -1));
    if (typedArray.hasValue(R.styleable.trackasia_LocationComponent_trackasia_foregroundStaleTintColor)) {
      builder.foregroundStaleTintColor(typedArray.getColor(
        R.styleable.trackasia_LocationComponent_trackasia_foregroundStaleTintColor, -1));
    }
    builder.backgroundDrawableStale(typedArray.getResourceId(
      R.styleable.trackasia_LocationComponent_trackasia_backgroundDrawableStale, -1));
    if (typedArray.hasValue(R.styleable.trackasia_LocationComponent_trackasia_backgroundStaleTintColor)) {
      builder.backgroundStaleTintColor(typedArray.getColor(
        R.styleable.trackasia_LocationComponent_trackasia_backgroundStaleTintColor, -1));
    }
    builder.bearingDrawable(typedArray.getResourceId(
      R.styleable.trackasia_LocationComponent_trackasia_bearingDrawable, -1));
    if (typedArray.hasValue(R.styleable.trackasia_LocationComponent_trackasia_bearingTintColor)) {
      builder.bearingTintColor(typedArray.getColor(
        R.styleable.trackasia_LocationComponent_trackasia_bearingTintColor, -1));
    }
    if (typedArray.hasValue(R.styleable.trackasia_LocationComponent_trackasia_enableStaleState)) {
      builder.enableStaleState(typedArray.getBoolean(
        R.styleable.trackasia_LocationComponent_trackasia_enableStaleState, true));
    }
    if (typedArray.hasValue(R.styleable.trackasia_LocationComponent_trackasia_staleStateTimeout)) {
      builder.staleStateTimeout(typedArray.getInteger(
        R.styleable.trackasia_LocationComponent_trackasia_staleStateTimeout, (int) STALE_STATE_DELAY_MS));
    }
    builder.gpsDrawable(typedArray.getResourceId(
      R.styleable.trackasia_LocationComponent_trackasia_gpsDrawable, -1));
    float elevation = typedArray.getDimension(
      R.styleable.trackasia_LocationComponent_trackasia_elevation, 0);
    builder.accuracyColor(typedArray.getColor(
      R.styleable.trackasia_LocationComponent_trackasia_accuracyColor, -1));
    builder.accuracyAlpha(typedArray.getFloat(
      R.styleable.trackasia_LocationComponent_trackasia_accuracyAlpha, ACCURACY_ALPHA_DEFAULT));
    builder.elevation(elevation);

    builder.trackingGesturesManagement(typedArray.getBoolean(
      R.styleable.trackasia_LocationComponent_trackasia_trackingGesturesManagement, false));
    builder.trackingInitialMoveThreshold(typedArray.getDimension(
      R.styleable.trackasia_LocationComponent_trackasia_trackingInitialMoveThreshold,
      context.getResources().getDimension(R.dimen.trackasia_locationComponentTrackingInitialMoveThreshold)));
    builder.trackingMultiFingerMoveThreshold(typedArray.getDimension(
      R.styleable.trackasia_LocationComponent_trackasia_trackingMultiFingerMoveThreshold,
      context.getResources().getDimension(R.dimen.trackasia_locationComponentTrackingMultiFingerMoveThreshold)));

    builder.padding(new int[] {
      typedArray.getInt(R.styleable.trackasia_LocationComponent_trackasia_iconPaddingLeft, 0),
      typedArray.getInt(R.styleable.trackasia_LocationComponent_trackasia_iconPaddingTop, 0),
      typedArray.getInt(R.styleable.trackasia_LocationComponent_trackasia_iconPaddingRight, 0),
      typedArray.getInt(R.styleable.trackasia_LocationComponent_trackasia_iconPaddingBottom, 0),
    });

    builder.layerAbove(
      typedArray.getString(R.styleable.trackasia_LocationComponent_trackasia_layer_above));

    builder.layerBelow(
      typedArray.getString(R.styleable.trackasia_LocationComponent_trackasia_layer_below));

    float minScale = typedArray.getFloat(
      R.styleable.trackasia_LocationComponent_trackasia_minZoomIconScale, MIN_ZOOM_ICON_SCALE_DEFAULT);
    float maxScale = typedArray.getFloat(
      R.styleable.trackasia_LocationComponent_trackasia_maxZoomIconScale, MAX_ZOOM_ICON_SCALE_DEFAULT);
    ...
    float trackingAnimationDurationMultiplier = typedArray.getFloat(
      R.styleable.trackasia_LocationComponent_trackasia_trackingAnimationDurationMultiplier,
    ...
    builder.compassAnimationEnabled = typedArray.getBoolean(
      R.styleable.trackasia_LocationComponent_trackasia_compassAnimationEnabled, true
    );

    builder.accuracyAnimationEnabled = typedArray.getBoolean(
      R.styleable.trackasia_LocationComponent_trackasia_accuracyAnimationEnabled, true
    );

    builder.pulseEnabled = typedArray.getBoolean(
      R.styleable.trackasia_LocationComponent_trackasia_pulsingLocationCircleEnabled, false
    );

    builder.pulseFadeEnabled = typedArray.getBoolean(
      R.styleable.trackasia_LocationComponent_trackasia_pulsingLocationCircleFadeEnabled, true
    );

    if (typedArray.hasValue(R.styleable.trackasia_LocationComponent_trackasia_pulsingLocationCircleColor)) {
      builder.pulseColor(typedArray.getColor(
        R.styleable.trackasia_LocationComponent_trackasia_pulsingLocationCircleColor,
        -1));
    }

    builder.pulseSingleDuration = typedArray.getFloat(
      R.styleable.trackasia_LocationComponent_trackasia_pulsingLocationCircleDuration, CIRCLE_PULSING_DURATION_DEFAULT_MS
    );

    builder.pulseMaxRadius = typedArray.getFloat(
      R.styleable.trackasia_LocationComponent_trackasia_pulsingLocationCircleRadius, CIRCLE_PULSING_MAX_RADIUS_DEFAULT
    );

    builder.pulseAlpha = typedArray.getFloat(
      R.styleable.trackasia_LocationComponent_trackasia_pulsingLocationCircleAlpha, CIRCLE_PULSING_ALPHA_DEFAULT);
  ...
  public static Builder builder(@NonNull Context context) {
    return LocationComponentOptions.createFromAttributes(context,
      R.style.trackasia_LocationComponent).toBuilder();
  }
