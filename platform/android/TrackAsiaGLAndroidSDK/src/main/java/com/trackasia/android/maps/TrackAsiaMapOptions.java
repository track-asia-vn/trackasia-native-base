...
/**
 * Defines configuration TrackAsiaMapOptions for a TrackAsiaMap. These options can be used when adding a
...
public class TrackAsiaMapOptions implements Parcelable {
  ...
  private double minZoom = TrackAsiaConstants.MINIMUM_ZOOM;
  private double maxZoom = TrackAsiaConstants.MAXIMUM_ZOOM;
  private double minPitch = TrackAsiaConstants.MINIMUM_PITCH;
  private double maxPitch = TrackAsiaConstants.MAXIMUM_PITCH;
  ...
  @VisibleForTesting
  static TrackAsiaMapOptions createFromAttributes(@NonNull TrackAsiaMapOptions trackasiaMapOptions,
                                                 @NonNull Context context,
                                                 @Nullable TypedArray typedArray) {
    float pxlRatio = context.getResources().getDisplayMetrics().density;
    try {
      trackasiaMapOptions.camera(new CameraPosition.Builder(typedArray).build());

      // deprecated
      trackasiaMapOptions.apiBaseUrl(typedArray.getString(R.styleable.trackasia_MapView_trackasia_apiBaseUrl));

      String baseUri = typedArray.getString(R.styleable.trackasia_MapView_trackasia_apiBaseUri);
      if (!TextUtils.isEmpty(baseUri)) {
        // override deprecated property if a value of the new type was provided
        trackasiaMapOptions.apiBaseUri(baseUri);
      }

      trackasiaMapOptions.zoomGesturesEnabled(
        typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_uiZoomGestures, true));
      trackasiaMapOptions.scrollGesturesEnabled(
        typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_uiScrollGestures, true));
      trackasiaMapOptions.horizontalScrollGesturesEnabled(
        typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_uiHorizontalScrollGestures, true));
      trackasiaMapOptions.rotateGesturesEnabled(
        typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_uiRotateGestures, true));
      trackasiaMapOptions.tiltGesturesEnabled(
        typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_uiTiltGestures, true));
      trackasiaMapOptions.doubleTapGesturesEnabled(
        typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_uiDoubleTapGestures, true));
      trackasiaMapOptions.quickZoomGesturesEnabled(
        typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_uiQuickZoomGestures, true));

      trackasiaMapOptions.maxZoomPreference(typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraZoomMax,
        TrackAsiaConstants.MAXIMUM_ZOOM));
      trackasiaMapOptions.minZoomPreference(typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraZoomMin,
        TrackAsiaConstants.MINIMUM_ZOOM));
      trackasiaMapOptions.maxPitchPreference(typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraPitchMax,
        TrackAsiaConstants.MAXIMUM_PITCH));
      trackasiaMapOptions.minPitchPreference(typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraPitchMin,
        TrackAsiaConstants.MINIMUM_PITCH));

      trackasiaMapOptions.compassEnabled(typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_uiCompass, true));
      trackasiaMapOptions.compassGravity(typedArray.getInt(R.styleable.trackasia_MapView_trackasia_uiCompassGravity,
        Gravity.TOP | Gravity.END));
      trackasiaMapOptions.compassMargins(new int[] {
        (int) (typedArray.getDimension(R.styleable.trackasia_MapView_trackasia_uiCompassMarginLeft,
          FOUR_DP * pxlRatio)),
        ((int) typedArray.getDimension(R.styleable.trackasia_MapView_trackasia_uiCompassMarginTop,
          FOUR_DP * pxlRatio)),
        ((int) typedArray.getDimension(R.styleable.trackasia_MapView_trackasia_uiCompassMarginRight,
          FOUR_DP * pxlRatio)),
        ((int) typedArray.getDimension(R.styleable.trackasia_MapView_trackasia_uiCompassMarginBottom,
          FOUR_DP * pxlRatio))});
      trackasiaMapOptions.compassFadesWhenFacingNorth(typedArray.getBoolean(
        R.styleable.trackasia_MapView_trackasia_uiCompassFadeFacingNorth, true));
      Drawable compassDrawable = typedArray.getDrawable(
        R.styleable.trackasia_MapView_trackasia_uiCompassDrawable);
      if (compassDrawable == null) {
        compassDrawable = ResourcesCompat.getDrawable(context.getResources(), R.drawable.trackasia_compass_icon, null);
      }
      trackasiaMapOptions.compassImage(compassDrawable);

      trackasiaMapOptions.logoEnabled(typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_uiLogo, true));
      trackasiaMapOptions.logoGravity(typedArray.getInt(R.styleable.trackasia_MapView_trackasia_uiLogoGravity,
        Gravity.BOTTOM | Gravity.START));
      trackasiaMapOptions.logoMargins(new int[] {
      ...
      trackasiaMapOptions.attributionTintColor(typedArray.getColor(
        R.styleable.trackasia_MapView_trackasia_uiAttributionTintColor, UNDEFINED_COLOR));
      trackasiaMapOptions.attributionEnabled(typedArray.getBoolean(
        R.styleable.trackasia_MapView_trackasia_uiAttribution, true));
      trackasiaMapOptions.attributionGravity(typedArray.getInt(
        R.styleable.trackasia_MapView_trackasia_uiAttributionGravity, Gravity.BOTTOM | Gravity.START));
      trackasiaMapOptions.attributionMargins(new int[] {
        ...
        (int) (typedArray.getDimension(R.styleable.trackasia_MapView_trackasia_uiAttributionMarginRight,
          FOUR_DP * pxlRatio)),
        (int) (typedArray.getDimension(R.styleable.trackasia_MapView_trackasia_uiAttributionMarginBottom,
          FOUR_DP * pxlRatio))});
      trackasiaMapOptions.textureMode(
        typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_renderTextureMode, false));
      trackasiaMapOptions.translucentTextureSurface(
        typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_renderTextureTranslucentSurface, false));
      trackasiaMapOptions.setPrefetchesTiles(
        typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_enableTilePrefetch, true));
      trackasiaMapOptions.setPrefetchZoomDelta(
        typedArray.getInt(R.styleable.trackasia_MapView_trackasia_prefetchZoomDelta, 4));
      trackasiaMapOptions.renderSurfaceOnTop(
        typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_enableZMediaOverlay, false));

      trackasiaMapOptions.localIdeographFontFamilyEnabled =
      ...
      if (localIdeographFontFamiliesResId != 0) {
        ...
        trackasiaMapOptions.localIdeographFontFamily(localIdeographFontFamilies);
      } else {
        ...
        if (localIdeographFontFamily == null) {
          localIdeographFontFamily = TrackAsiaConstants.DEFAULT_FONT;
        }
        trackasiaMapOptions.localIdeographFontFamily(localIdeographFontFamily);
      }

      trackasiaMapOptions.pixelRatio(
        typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_pixelRatio, 0));
      trackasiaMapOptions.foregroundLoadColor(
        typedArray.getInt(R.styleable.trackasia_MapView_trackasia_foregroundLoadColor, LIGHT_GRAY)
      );
      trackasiaMapOptions.crossSourceCollisions(
        typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_cross_source_collisions, true)
      );
    } finally {
      typedArray.recycle();
    }
  ...
  /**
   * Specifies the visibility state of a trackasia_compass_icon for a map view.
   *
   * @param enabled True and trackasia_compass_icon is shown
   * @return This
   */
  @NonNull
  ...
  /**
   * Specifies the gravity state of trackasia_compass_icon for a map view.
   *
  ...
  /**
   * Specifies the margin state of trackasia_compass_icon for a map view
   *
  ...
  /**
   * Specifies if the trackasia_compass_icon fades to invisible when facing north.
   * <p>
   * By default this value is true.
   * </p>
   *
   * @param compassFadeWhenFacingNorth true is trackasia_compass_icon fades to invisble
   * @return This
   */
  @NonNull
   ...
   * <p>
   * By default this value is R.drawable.trackasia_compass_icon.
   * </p>
   *
   ...
   * Default font for local ideograph font family is {@link TrackAsiaConstants#DEFAULT_FONT}.
   *
   ...
   * will be selected. If no valid font found, it defaults to {@link TrackAsiaConstants#DEFAULT_FONT}.
   * <p>
   ...
   * {@link TrackAsiaConstants#DEFAULT_FONT}.
   * </p>
   *
  ...
  /**
   * Get the current configured visibility state for trackasia_compass_icon for a map view.
   *
   * @return Visibility state of the trackasia_compass_icon
   */
  ...
  /**
   * Get the current configured gravity state for trackasia_compass_icon for a map view.
   *
   * @return Gravity state of the trackasia_compass_icon
   */
  ...
  /**
   * Get the current configured margins for trackasia_compass_icon for a map view.
   *
   * @return Margins state of the trackasia_compass_icon
   */
  ...
  /**
   * Get the current configured state for fading the trackasia_compass_icon when facing north.
   *
   * @return True if trackasia_compass_icon fades to invisible when facing north
   */
