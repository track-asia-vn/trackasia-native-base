...
public final class UiSettings {
  ...
  private void initialiseCompass(TrackAsiaMapOptions options, @NonNull Resources resources) {
    ...
    if (compassMargins != null) {
      ...
      int tenDp = (int) resources.getDimension(R.dimen.trackasia_four_dp);
    ...
    if (options.getCompassImage() == null) {
      options.compassImage(ResourcesCompat.getDrawable(resources, R.drawable.trackasia_compass_icon, null));
    }
  ...
  private void setLogoMargins(@NonNull Resources resources, @Nullable int[] logoMargins) {
    if (logoMargins != null) {
      ...
      int fourDp = (int) resources.getDimension(R.dimen.trackasia_four_dp);
  ...
  public void setCompassEnabled(boolean compassEnabled) {
    if (compassEnabled && !isCompassInitialized) {
      initialiseCompass(mapView.trackasiaMapOptions, mapView.getContext().getResources());
    }
    if (compassView != null) {
  ...
  public void setLogoEnabled(boolean enabled) {
    if (enabled && !isLogoInitialized) {
      initialiseLogo(mapView.trackasiaMapOptions, mapView.getContext().getResources());
    }
    if (logoView != null) {
  ...
  public void setAttributionEnabled(boolean enabled) {
    if (enabled && !isAttributionInitialized) {
      initialiseAttribution(mapView.getContext(), mapView.trackasiaMapOptions);
    }
  ...
  public void setAttributionTintColor(@ColorInt int tintColor) {
    ...
    if (Color.alpha(tintColor) == 0) {
      ColorUtils.setTintList(attributionsView,
        ContextCompat.getColor(attributionsView.getContext(), R.color.trackasia_blue));
    } else {
