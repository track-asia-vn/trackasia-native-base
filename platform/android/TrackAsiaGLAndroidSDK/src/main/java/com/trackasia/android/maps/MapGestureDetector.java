  ...
  private void initializeGestureListeners(@NonNull Context context, boolean attachDefaultListeners) {
    if (attachDefaultListeners) {
      ...
      ScaleGestureListener scaleGestureListener = new ScaleGestureListener(
        context.getResources().getDimension(R.dimen.trackasia_density_constant),
        context.getResources().getDimension(R.dimen.trackasia_minimum_scale_speed),
        context.getResources().getDimension(R.dimen.trackasia_minimum_angled_scale_speed),
        context.getResources().getDimension(R.dimen.trackasia_minimum_scale_velocity)
      );
      RotateGestureListener rotateGestureListener = new RotateGestureListener(
        context.getResources().getDimension(R.dimen.trackasia_minimum_scale_span_when_rotating),
        context.getResources().getDimension(R.dimen.trackasia_density_constant),
        context.getResources().getDimension(R.dimen.trackasia_angular_velocity_multiplier),
        context.getResources().getDimension(R.dimen.trackasia_minimum_angular_velocity),
        context.getResources().getDimension(
          com.mapbox.android.gestures.R.dimen.mapbox_defaultScaleSpanSinceStartThreshold));
