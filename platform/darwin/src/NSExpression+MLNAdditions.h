...
/**
 ...
 <a href="https://trackasia.org/trackasia-style-spec/expressions/#interpolate"><code>interpolate</code></a>
...
/**
 ...
 <a href="https://trackasia.org/trackasia-style-spec/expressions/">MapLibre Style Spec</a>.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a href="https://trackasia.org/trackasia-style-spec/expressions/#heatmap-density"><code>heatmap-density</code></a>
 expression operator in the MapLibre Style Spec.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a href="https://trackasia.org/trackasia-style-spec/expressions/#line-progress"><code>line-progress</code></a>
 expression operator in the MapLibre Style Spec.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a href="https://trackasia.org/trackasia-style-spec/expressions/#geometry-type"><code>geometry-type</code></a>
 expression operator in the MapLibre Style Spec.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a href="https://trackasia.org/trackasia-style-spec/expressions/#properties"><code>properties</code></a>
 expression operator in the MapLibre Style Spec.
 */
 ...
 */
+ (instancetype)mgl_expressionForConditional:(nonnull NSPredicate *)conditionPredicate trueExpression:(nonnull NSExpression *)trueExpression falseExpresssion:(nonnull NSExpression *)falseExpression NS_SWIFT_NAME(init(forMLNConditional:trueExpression:falseExpression:));
 ...
 */
+ (instancetype)mgl_expressionForMatchingExpression:(nonnull NSExpression *)inputExpression inDictionary:(nonnull NSDictionary<NSExpression *, NSExpression *> *)matchedExpressions defaultExpression:(nonnull NSExpression *)defaultExpression NS_SWIFT_NAME(init(forMLNMatchingKey:in:default:));
