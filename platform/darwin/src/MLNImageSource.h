...
/**
 ...
 Each
 <a href="https://trackasia.org/trackasia-style-spec/#sources-image"><code>image</code></a>
 ...
 let source = MLNImageSource(identifier: "radar", coordinateQuad: coordinates, url: URL(string: "https://trackasia.org/trackasia-gl-js-docs/assets/radar.gif")!)
