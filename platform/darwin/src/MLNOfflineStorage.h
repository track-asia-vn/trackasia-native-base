 ...
 */
FOUNDATION_EXTERN MLN_EXPORT const NSNotificationName MLNOfflinePackMaximumMapboxTilesReachedNotification;
 ...
 */
typedef void (^MLNOfflinePackAdditionCompletionHandler)(MLNOfflinePack * _Nullable pack, NSError * _Nullable error);
 ...
 */
typedef void (^MLNBatchedOfflinePackAdditionCompletionHandler)(NSURL *fileURL, NSArray<MLNOfflinePack *> * _Nullable packs, NSError * _Nullable error);
...
typedef NS_ENUM(NSUInteger, MLNResourceKind) {
    ...
    /** TileJSON file as specified in https://trackasia.org/trackasia-style-spec/root/#sources */
    MLNResourceKindSource,
    /** A vector or raster tile as described in the style sheet at
        https://trackasia.org/trackasia-style-spec/sources/ */
    MLNResourceKindTile,
    /** Signed distance field glyphs for text rendering. These are the URLs specified in the style
        in https://trackasia.org/trackasia-style-spec/root/#glyphs */
    MLNResourceKindGlyphs,
    /** Image part of a sprite sheet. It is constructed of the prefix in
        https://trackasia.org/trackasia-style-spec/root/#sprite and a PNG file extension. */
    MLNResourceKindSpriteImage,
    /** JSON part of a sprite sheet. It is constructed of the prefix in
        https://trackasia.org/trackasia-style-spec/root/#sprite and a JSON file extension. */
 ...
 */
- (void)addContentsOfFile:(NSString *)filePath withCompletionHandler:(nullable MLNBatchedOfflinePackAdditionCompletionHandler)completion;
...
/**
 ...
 @param completion The completion handler to call once the contents of the given
    ...
    asynchronously on the main queue.
 */
- (void)addContentsOfURL:(NSURL *)fileURL withCompletionHandler:(nullable MLNBatchedOfflinePackAdditionCompletionHandler)completion;
 ...
 */
- (void)addPackForRegion:(id <MLNOfflineRegion>)region withContext:(NSData *)context completionHandler:(nullable MLNOfflinePackAdditionCompletionHandler)completion;
 ...
 */
- (void)removePack:(MLNOfflinePack *)pack withCompletionHandler:(nullable MLNOfflinePackRemovalCompletionHandler)completion;
