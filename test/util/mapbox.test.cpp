...
const TileServerOptions mapLibreTileServerOptions = TileServerOptions::TrackAsiaConfiguration();
...
TEST(TrackAsia, CanonicalURL) {
    EXPECT_EQ(
        ...
        mbgl::util::mapbox::normalizeStyleURL(mapboxFixture::mapLibreTileServerOptions, "trackasia://maps/style", ""));
    EXPECT_EQ(
        "https://demotiles.track-asia.com/tiles/tiles.json",
        mbgl::util::mapbox::normalizeSourceURL(mapboxFixture::mapLibreTileServerOptions, "trackasia://tiles/tiles", ""));
    EXPECT_EQ("https://demotiles.track-asia.com/font/{fontstack}/{start}-{end}.pbf",
              mbgl::util::mapbox::normalizeGlyphsURL(
                  mapboxFixture::mapLibreTileServerOptions, "trackasia://fonts/{fontstack}/{start}-{end}.pbf", ""));
